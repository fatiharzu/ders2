...
public class C02_ImmutableClass {
    public static void main(String[] args) {
        ...
        //Aslinda String non-primitive oldugundan new kelimesi kullanmak gerekir
        ...
        System.out.println("new ile olsutrdugumuz  E degiskeni : "+E);
